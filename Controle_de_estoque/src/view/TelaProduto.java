	...
	private void inserirProduto() {
		...
		if (txtProduto.getText().isEmpty()) {
			...
			try {
				...
				// Formatar o valor do JCalendar para inserção cprreta no banco
				...
				if (sucesso == 1) {
					JOptionPane.showMessageDialog(null, "Prouto cadastrado com sucesso");
				}
				//Limpar campos
				...
				JOptionPane.showMessageDialog(null, "Codigo de barras duplicado");
				txtBarcode.setText(null);
